...
class ilObjTest extends ilObject implements ilMarkSchemaAware, ilEctsGradesEnabled
{
     ...
     *
     * @param $a_id integer
     *            Reference_id or object_id.
     * @param $a_call_by_reference boolean
     *            Treat the id as reference_id (true) or object_id (false).
     *            
     * @return \ilObjTest
     */
    ...
    public function getQuestionSetConfig()
    {
        ...
        if ($this->questionSetConfig === null) {
            $factory = new ilTestQuestionSetConfigFactory($DIC->repositoryTree(), $DIC->database(), $DIC['ilPluginAdmin'], $this);
    ...
    function deleteTest()
    {
        ...
        $affectedRows = $ilDB->manipulateF("DELETE FROM tst_mark WHERE test_fi = %s", array(
            'integer'
        ), array(
            $this->getTestId()
        ));

        $affectedRows = $ilDB->manipulateF("DELETE FROM tst_tests WHERE test_id = %s", array(
            'integer'
        ), array(
            $this->getTestId()
        ));
    ...
    function createExportDirectory()
    {
        ...
        if (! is_writable($tst_data_dir)) {
            $this->ilias->raiseError("Test Data Directory (" . $tst_data_dir . ") not writeable.", $this->ilias->error_obj->MESSAGE);
        }
    ...
    public static function _createImportDirectory()
    {
        ...
        if (! is_writable($tst_data_dir)) {
            $ilias->raiseError("Test Data Directory (" . $tst_data_dir . ") not writeable.", $ilias->error_obj->FATAL);
        }
    ...
    public function saveCompleteStatus(ilTestQuestionSetConfig $testQuestionSetConfig)
    {
        ...
        if ($this->getTestId() > 0) {
            $ilDB->manipulateF("UPDATE tst_tests SET complete = %s WHERE test_id = %s", array(
                'text',
                'integer'
            ), array(
                $complete,
    ...
    public function saveToDb($properties_only = FALSE)
    {
        ...
        if ($this->test_id == - 1) {
            ...
            $ilDB->insert('tst_tests', array(
                ...
                'intro_enabled' => array(
                    'integer',
                    (int) $this->isIntroductionEnabled()
                ),
                'introduction' => array(
                    'text',
                ...
                'showfinalstatement' => array(
                    'integer',
                    $this->getShowFinalStatement()
                ),
                'sequence_settings' => array(
                    'integer',
                    $this->getSequenceSettings()
                ),
                'score_reporting' => array(
                    'integer',
                    $this->getScoreReporting()
                ),
                'instant_verification' => array(
                    'text',
                    $this->getInstantFeedbackSolution()
                ),
                'answer_feedback_points' => array(
                    'text',
                ...
                'starting_time_enabled' => array(
                    'integer',
                    $this->isStartingTimeEnabled()
                ),
                'starting_time' => array(
                    'integer',
                    $this->getStartingTime()
                ),
                'ending_time_enabled' => array(
                    'integer',
                    $this->isEndingTimeEnabled()
                ),
                'ending_time' => array(
                    'integer',
                    $this->getEndingTime()
                ...
                'complete' => array(
                    'text',
                    $this->isComplete($testQuestionSetConfig)
                ),
                'ects_output' => array(
                    'text',
                    $this->getECTSOutput()
                ...
                'limit_users_enabled' => array(
                    'integer',
                    (int) $this->isLimitUsersEnabled()
                ),
                'allowedusers' => array(
                    'integer',
                    $this->getAllowedUsers()
                ),
                'alloweduserstimegap' => array(
                    'integer',
                ...
                'print_bs_with_res' => array(
                    'integer',
                    (int) $this->isBestSolutionPrintedWithResult()
                ),
                'obligations_enabled' => array(
                    'integer',
                    (int) $this->areObligationsEnabled()
                ),
                'offer_question_hints' => array(
                    'integer',
                ...
                'autosave_ival' => array(
                    'integer',
                    (int) $this->getAutosaveIval()
                ),
                'pass_deletion_allowed' => array(
                    'integer',
                    (int) $this->isPassDeletionAllowed()
                ),
                'enable_examview' => array(
                    'integer',
                    (int) $this->getEnableExamview()
                ),
                'show_examview_html' => array(
                    'integer',
                    (int) $this->getShowExamviewHtml()
                ),
                'show_examview_pdf' => array(
                    'integer',
                    (int) $this->getShowExamviewPdf()
                ),
                'redirection_mode' => array(
                    'integer',
                    (int) $this->getRedirectionMode()
                ),
                'redirection_url' => array(
                    'text',
                    (string) $this->getRedirectionUrl()
                ),
                'enable_archiving' => array(
                    'integer',
                    (int) $this->getEnableArchiving()
                ),
                'examid_in_test_pass' => array(
                    'integer',
                    (int) $this->isShowExamIdInTestPassEnabled()
                ),
                'examid_in_test_res' => array(
                    'integer',
                    (int) $this->isShowExamIdInTestResultsEnabled()
                ),
                'sign_submission' => array(
                    'integer',
                    (int) $this->getSignSubmission()
                ),
                'question_set_type' => array(
                    'text',
                    $this->getQuestionSetType()
                ),
                'char_selector_availability' => array(
                    'integer',
                    (int) $this->getCharSelectorAvailability()
                ),
                'char_selector_definition' => array(
                    'text',
                    (string) $this->getCharSelectorDefinition()
                ),
                'skill_service' => array(
                    'integer',
                    (int) $this->isSkillServiceEnabled()
                ),
                'result_tax_filters' => array(
                    'text',
                    serialize((array) $this->getResultFilterTaxIds())
                ),
                'show_grading_status' => array(
                    'integer',
                    (int) $this->isShowGradingStatusEnabled()
                ),
                'show_grading_mark' => array(
                    'integer',
                    (int) $this->isShowGradingMarkEnabled()
                ),
                'follow_qst_answer_fixation' => array(
                    'integer',
                    (int) $this->isFollowupQuestionAnswerFixationEnabled()
                ),
                'inst_fb_answer_fixation' => array(
                    'integer',
            ...
            $oldrow = array();
            if (ilObjAssessmentFolder::_enabledAssessmentLogging()) {
                $result = $ilDB->queryF("SELECT * FROM tst_tests WHERE test_id = %s", array(
                    'integer'
                ), array(
                    $this->test_id
                ));
            ...
            include_once ("./Modules/Test/classes/class.ilObjAssessmentFolder.php");
            if (ilObjAssessmentFolder::_enabledAssessmentLogging()) {
                $logresult = $ilDB->queryF("SELECT * FROM tst_tests WHERE test_id = %s", array(
                    'integer'
                ), array(
                    $this->getTestId()
                ));
            ...
            if ($this->evalTotalPersons() > 0) {
                ...
                if ($this->getNrOfTries() > 0) {
                    ...
                    $aresult = $ilDB->queryF("SELECT active_id FROM tst_active WHERE test_fi = %s AND tries >= %s AND submitted = %s", array(
                        'integer',
                        'integer',
                        'integer'
                    ), array(
                    ...
                    while ($row = $ilDB->fetchAssoc($aresult)) {
                        $ilDB->manipulateF("UPDATE tst_active SET submitted = %s, submittimestamp = %s WHERE active_id = %s", array(
                            'integer',
                            'timestamp',
                            'integer'
                        ), array(
                    ...
                    // set all finished tests with nr of passes >= allowed passes not finished
                    $aresult = $ilDB->queryF("SELECT active_id FROM tst_active WHERE test_fi = %s AND submitted = %s", array(
                        'integer',
                        'integer'
                    ), array(
                        $this->getTestId(),
    ...
    function saveQuestionsToDb()
    {
        ...
        include_once "./Modules/Test/classes/class.ilObjAssessmentFolder.php";
        if (ilObjAssessmentFolder::_enabledAssessmentLogging()) {
            $result = $ilDB->queryF("SELECT question_fi FROM tst_test_question WHERE test_fi = %s ORDER BY sequence", array(
                'integer'
            ), array(
                $this->getTestId()
            ));
        ...
        $rset = $ilDB->queryF($currentQuestionsObligationsQuery, array(
            'integer'
        ), array(
            $this->getTestId()
        ));
        ...
        $affectedRows = $ilDB->manipulateF("DELETE FROM tst_test_question WHERE test_fi = %s", array(
            'integer'
        ), array(
            $this->getTestId()
        ));
    ...
    protected function isNewRandomTest()
    {
        global $DIC;
        $ilDB = $DIC['ilDB'];
        $result = $ilDB->queryF('SELECT copy_id FROM tst_rnd_cpy WHERE tst_fi = %s', array(
            'integer'
        ), array(
            $this->getTestId()
        ));
     ...
     *
     * @param integer $nr_of_questions
     *            Number of questions to return
     * @param integer $questionpool
     *            ID of questionpool to choose the questions from (0 = all available questionpools)
     * @param boolean $user_obj_id
     *            Use the object id instead of the reference id when set to true
     * @param array $qpls
     *            An array of questionpool id's if the random questions should only be chose from the contained questionpools
    ...
    function randomSelectQuestions($nr_of_questions, $questionpool, $use_obj_id = 0, $qpls = "", $pass = NULL)
    {
        ...
        $result = $ilDB->queryF("SELECT qpl_questions.original_id FROM qpl_questions, tst_test_question WHERE qpl_questions.question_id = tst_test_question.question_fi AND qpl_questions.tstamp > 0 AND tst_test_question.test_fi = %s", array(
            "integer"
        ), array(
            $this->getTestId()
        ));
        ...
        if ($questionpool == 0) {
            $result = $ilDB->queryF("SELECT question_id FROM qpl_questions WHERE original_id IS NULL $available $constraint_qpls AND owner > %s AND complete = %s $original_clause", array(
                'integer',
                'text'
            ), array(
                0,
            ...
            $result = $ilDB->queryF("SELECT question_id FROM qpl_questions WHERE original_id IS NULL AND obj_fi = %s AND owner > %s AND complete = %s $original_clause", array(
                'integer',
                'integer',
                'text'
            ), array(
    ...
    function getNrOfResultsForPass($active_id, $pass)
    {
        ...
        $result = $ilDB->queryF("SELECT test_result_id FROM tst_test_result WHERE active_fi = %s AND pass = %s", array(
            'integer',
            'integer'
        ), array(
            $active_id,
    ...
    function hasRandomQuestionsForPass($active_id, $pass)
    {
        global $DIC;
        $ilDB = $DIC['ilDB'];
        $result = $ilDB->queryF("SELECT test_random_question_id FROM tst_test_rnd_qst WHERE active_fi = %s AND pass = %s", array(
            'integer',
            'integer'
        ), array(
            $active_id,
    ...
    public function loadFromDb()
    {
        ...
        $result = $ilDB->queryF("SELECT * FROM tst_tests WHERE obj_fi = %s", array(
            'integer'
        ), array(
            $this->getId()
        ));
     ...
     *            The user id of the test user (necessary for random tests)
     * @access public
     */
    function loadQuestions($active_id = "", $pass = NULL)
    {
        ...
        if ($this->isRandomTest()) {
            ...
            $result = $ilDB->queryF("SELECT tst_test_rnd_qst.* FROM tst_test_rnd_qst, qpl_questions WHERE tst_test_rnd_qst.active_fi = %s AND qpl_questions.question_id = tst_test_rnd_qst.question_fi AND tst_test_rnd_qst.pass = %s ORDER BY sequence", array(
                'integer',
                'integer'
            ), array(
                $active_id,
            ...
            if ($result->numRows() == 0) {
                $result = $ilDB->queryF("SELECT tst_test_rnd_qst.* FROM tst_test_rnd_qst, qpl_questions WHERE tst_test_rnd_qst.active_fi = %s AND qpl_questions.question_id = tst_test_rnd_qst.question_fi AND tst_test_rnd_qst.pass = 0 ORDER BY sequence", array(
                    'integer'
                ), array(
                    $active_id
                ));
            ...
            $result = $ilDB->queryF("SELECT tst_test_question.* FROM tst_test_question, qpl_questions WHERE tst_test_question.test_fi = %s AND qpl_questions.question_id = tst_test_question.question_fi ORDER BY sequence", array(
                'integer'
            ), array(
                $this->test_id
            ));
     ...
     *            An introduction string for the test
     * @access public
     * @see $introduction
     */
     ...
     *
     * @param integer $a_info
     *            1 for the complete information, 0 otherwise
     * @access public
     * @see $_showinfo
     */
     ...
     *
     * @param integer $a_js
     *            1 to force JavaScript, 0 otherwise
     * @access public
     * @see $_forcejs
     */
     ...
     *
     * @param $mode string
     *            Output mode of the style sheet ("output" or "filesystem"). !"filesystem" generates the ILIAS
     ...
     * SEQUENCE SETTING = POSTPONING ENABLED !!
     *
     * @param integer $sequence_settings
     *            The POSTPONING ENABLED status
     */
     ...
     *
     * @param integer $instant_feedback
     *            If 1, the solution will be shown after answering a question
     * @access public
     ...
     * @param integer $answer_feedback
     *            If 1, answer specific feedback will be shown after answering a question
     * @access public
     * @see $answer_feedback
     */
     ...
     *
     * @param integer $answer_feedback_points
     *            If 1, answer specific feedback will show the reached points after answering a question
     * @access public
     ...
     *
     * @param timestamp $reporting_date
     *            The date and time the score reporting is available
     */
    ...
    public static function _getCountSystem($active_id)
    {
        global $DIC;
        $ilDB = $DIC['ilDB'];
        $result = $ilDB->queryF("SELECT tst_tests.count_system FROM tst_tests, tst_active WHERE tst_active.active_id = %s AND tst_active.test_fi = tst_tests.test_id", array(
            'integer'
        ), array(
            $active_id
        ));
    ...
    public static function _getPassScoring($active_id)
    {
        global $DIC;
        $ilDB = $DIC['ilDB'];
        $result = $ilDB->queryF("SELECT tst_tests.pass_scoring FROM tst_tests, tst_active WHERE tst_tests.test_id = tst_active.test_fi AND tst_active.active_id = %s", array(
            'integer'
        ), array(
            $active_id
        ));
    ...
    public static function _getMCScoring($active_id)
    {
        global $DIC;
        $ilDB = $DIC['ilDB'];
        $result = $ilDB->queryF("SELECT tst_tests.mc_scoring FROM tst_tests, tst_active WHERE tst_active.active_id = %s AND tst_active.test_fi = tst_tests.test_id", array(
            'integer'
        ), array(
            $active_id
        ));
    ...
    public static function _getScoreCutting($active_id)
    {
        global $DIC;
        $ilDB = $DIC['ilDB'];
        $result = $ilDB->queryF("SELECT tst_tests.score_cutting FROM tst_tests, tst_active WHERE tst_active.active_id = %s AND tst_tests.test_id = tst_active.test_fi", array(
            'integer'
        ), array(
            $active_id
        ));
     ...
     *
     * @param boolean $a_title
     *            TRUE if the test title should be shown in kiosk mode, FALSE otherwise
     * @access public
     */
     ...
     *
     * @param boolean $a_title
     *            TRUE if the participant's name should be shown in kiosk mode, FALSE otherwise
     * @access public
     */
    ...
    function _getTitleOutput($active_id)
    {
        ...
        $result = $ilDB->queryF("SELECT tst_tests.title_output FROM tst_tests, tst_active WHERE tst_tests.test_id = tst_active.test_fi AND tst_active.active_id = %s", array(
            'integer'
        ), array(
            $active_id
        ));
     ...
     *            The test id
     * @param boolean $use_active_user_setting
     *            If true, the tst_use_previous_answers- of the active user should be used as well
    ...
    public static function _getUsePreviousAnswers($active_id, $user_active_user_setting = false)
    {
        ...
        $result = $ilDB->queryF("SELECT tst_tests.use_previous_answers FROM tst_tests, tst_active WHERE tst_tests.test_id = tst_active.test_fi AND tst_active.active_id = %s", array(
            "integer"
        ), array(
            $active_id
        ));
     ...
     *
     * @param string $starting_time
     *            The starting time for the test. Empty string for no starting time.
     * @access public
     * @see $starting_time
     */
     ...
     *
     * @param string $ending_time
     *            The ending time for the test. Empty string for no ending time.
     * @access public
     * @see $ending_time
     */
     ...
     *
     * @param integer $nr_of_tries
     *            The maximum number of tries for the test. 0 for infinite tries.
     * @access public
     * @see $nr_of_tries
     */
     ...
     * **
     *
     * @param integer $use_previous_answers
     *            1 if the previous answers should be shown
     * @access public
     * @see $use_previous_answers
     */
     ...
     * **
     *
     * @param integer $title_output
     *            0 for full title, 1 for title without points, 2 for no title
     * @access public
     * @see $title_output
     */
     ...
     *
     * @param string $processing_time
     *            The maximum processing time for the test given in hh:mm:ss
     * @access public
     * @see $processing_time
     */
     ...
     *            0 to disable the processing time, 1 to enable the processing time
     * @access public
     * @see $processing_time
     */
     ...
     *
     * @param integer $reset
     *            1 to reset the processing time, 0 otherwise
     * @access public
     * @see $processing_time
     */
     ...
     *
     * @param integer $a_count_system
     *            The count system for the calculation of points.
     * @access public
     * @see $count_system
     */
     ...
     *
     * @param integer $a_score_cutting
     *            The type of score cutting. 0 for cut questions, 1 for cut tests
     * @access public
     * @see $score_cutting
     */
     ...
     *
     * @param integer $a_mc_scoring
     *            The scoring for multiple choice questions
     * @access public
     * @see $mc_scoring
     */
     ...
     *
     * @param integer $a_pass_scoring
     *            The pass scoring type
     * @access public
     * @see $pass_scoring
     */
     ...
     *            The database id of the question to be removed
     * @access public
     * @see $test_id
     */
    ...
    public function removeTestResultsByUserIds($userIds)
    {
        ...
        $ilDB->manipulateF("DELETE FROM usr_pref WHERE $IN_userIds AND keyword = %s", array(
            'text'
        ), array(
     ...
     *
     * @param integer $question_id
     *            The database id of the question to be moved up
     * @access public
     * @see $test_id
     */
    function questionMoveUp($question_id)
    {
        ...
        $result = $ilDB->queryF("SELECT * FROM tst_test_question WHERE test_fi=%s AND question_fi=%s", array(
            'integer',
            'integer'
        ), array(
            $this->getTestId(),
        ...
        if ($data->sequence > 1) {
            ...
            $result = $ilDB->queryF("SELECT * FROM tst_test_question WHERE test_fi=%s AND sequence=%s", array(
                'integer',
                'integer'
            ), array(
                $this->getTestId(),
            ...
            $affectedRows = $ilDB->manipulateF("UPDATE tst_test_question SET sequence=%s WHERE test_question_id=%s", array(
                'integer',
                'integer'
            ), array(
                $data->sequence,
                $data_previous->test_question_id
            ));
     ...
     *
     * @param integer $question_id
     *            The database id of the question to be moved down
     * @access public
     * @see $test_id
     */
     ...
     * @param ilTestQuestionSetConfig $testQuestionSetConfig
     * @param integer $question_id
     *            The database id of the inserted question
    ...
    public function insertQuestion(ilTestQuestionSetConfig $testQuestionSetConfig, $question_id, $linkOnly = false)
    {
        ...
        $result = $ilDB->queryF("SELECT MAX(sequence) seq FROM tst_test_question WHERE test_fi=%s", array(
            'integer'
        ), array(
            $this->getTestId()
        ));
        ...
        $next_id = $ilDB->nextId('tst_test_question');
        $affectedRows = $ilDB->manipulateF("INSERT INTO tst_test_question (test_question_id, test_fi, question_fi, sequence, tstamp) VALUES (%s, %s, %s, %s, %s)", array(
            'integer',
            'integer',
            'integer',
            'integer',
        ...
        $affectedRows = $ilDB->manipulateF("DELETE FROM tst_active WHERE test_fi = %s", array(
            'integer'
        ), array(
            $this->getTestId()
        ));
    ...
    function &getQuestionTitles()
    {
        ...
        if ($this->getQuestionSetType() == ilTestQuestionSetConfig::TYPE_FIXED) {
            global $DIC;
            $ilDB = $DIC['ilDB'];
            $result = $ilDB->queryF("SELECT qpl_questions.title FROM tst_test_question, qpl_questions WHERE tst_test_question.test_fi = %s AND tst_test_question.question_fi = qpl_questions.question_id ORDER BY tst_test_question.sequence", array(
                'integer'
            ), array(
                $this->getTestId()
            ));
    ...
    function &getQuestionTitlesAndIndexes()
    {
        ...
        if ($this->getQuestionSetType() == ilTestQuestionSetConfig::TYPE_FIXED) {
            global $DIC;
            $ilDB = $DIC['ilDB'];
            $result = $ilDB->queryF("SELECT qpl_questions.title, qpl_questions.question_id FROM tst_test_question, qpl_questions WHERE tst_test_question.test_fi = %s AND tst_test_question.question_fi = qpl_questions.question_id ORDER BY tst_test_question.sequence", array(
                'integer'
            ), array(
                $this->getTestId()
            ));
     ...
     * @param integer $nr
     *            The number of the question in the sequence
    ...
    function getQuestionDataset($question_id)
    {
        ...
        $result = $ilDB->queryF("SELECT qpl_questions.*, qpl_qst_type.type_tag FROM qpl_questions, qpl_qst_type WHERE qpl_questions.question_id = %s AND qpl_questions.question_type_fi = qpl_qst_type.question_type_id", array(
            'integer'
        ), array(
            $question_id
        ));
    ...
    function &getExistingQuestions($pass = NULL)
    {
        ...
        if ($this->isRandomTest()) {
            if (is_null($pass))
                $pass = 0;
            $result = $ilDB->queryF("SELECT qpl_questions.original_id FROM qpl_questions, tst_test_rnd_qst WHERE tst_test_rnd_qst.active_fi = %s AND tst_test_rnd_qst.question_fi = qpl_questions.question_id AND tst_test_rnd_qst.pass = %s", array(
                'integer',
                'integer'
            ), array(
                $active_id,
            ...
            $result = $ilDB->queryF("SELECT qpl_questions.original_id FROM qpl_questions, tst_test_question WHERE tst_test_question.test_fi = %s AND tst_test_question.question_fi = qpl_questions.question_id", array(
                'integer'
            ), array(
                $this->getTestId()
            ));
    ...
    function getQuestionType($question_id)
    {
        ...
        if ($question_id < 1)
            return - 1;
        $result = $ilDB->queryF("SELECT type_tag FROM qpl_questions, qpl_qst_type WHERE qpl_questions.question_id = %s AND qpl_questions.question_type_fi = qpl_qst_type.question_type_id", array(
            'integer'
        ), array(
            $question_id
        ));
     ...
     *
     * @param integer $user_id
     *            The database id of the user working with the test
     * @access public
     */
    function startWorkingTime($active_id, $pass)
    {
        ...
        $affectedRows = $ilDB->manipulateF("INSERT INTO tst_times (times_id, active_fi, started, finished, pass, tstamp) VALUES (%s, %s, %s, %s, %s, %s)", array(
            'integer',
            'integer',
            'timestamp',
            'timestamp',
     ...
     *
     * @param integer $times_id
     *            The database id of a working time entry
     * @access public
     */
    function updateWorkingTime($times_id)
    {
        ...
        $affectedRows = $ilDB->manipulateF("UPDATE tst_times SET finished = %s, tstamp = %s WHERE times_id = %s", array(
            'timestamp',
            'integer',
            'integer'
        ), array(
    ...
    function &getWorkedQuestions($active_id, $pass = NULL)
    {
        ...
        if (is_null($pass)) {
            $result = $ilDB->queryF("SELECT question_fi FROM tst_solutions WHERE active_fi = %s AND pass = %s GROUP BY question_fi", array(
                'integer',
                'integer'
            ), array(
                $active_id,
     ...
     *
     * @param integer $active_id
     *            The active id of the user
     * @param integer $currentpass
     *            The current test pass of the user
    ...
    function &getAllQuestions($pass = NULL)
    {
        ...
        if ($this->isRandomTest()) {
            ...
            $result = $ilDB->queryF("SELECT qpl_questions.* FROM qpl_questions, tst_test_rnd_qst WHERE tst_test_rnd_qst.question_fi = qpl_questions.question_id AND tst_test_rnd_qst.active_fi = %s AND tst_test_rnd_qst.pass = %s AND " . $ilDB->in('qpl_questions.question_id', $this->questions, false, 'integer'), array(
                'integer',
                'integer'
            ), array(
                $active_id,
     ...
     *            The anonymous id if the test is an anonymized test
    ...
    function getActiveIdOfUser($user_id = "", $anonymous_id = "")
    {
        ...
        if (($GLOBALS['DIC']['ilUser']->getId() == ANONYMOUS_USER_ID) && (strlen($_SESSION["tst_access_code"][$this->getTestId()]))) {
            $result = $ilDB->queryF("SELECT active_id FROM tst_active WHERE user_fi = %s AND test_fi = %s AND anonymous_id = %s", array(
                'integer',
                'integer',
                'text'
            ), array(
                $user_id,
                $this->test_id,
                $_SESSION["tst_access_code"][$this->getTestId()]
            ));
            ...
            $result = $ilDB->queryF("SELECT active_id FROM tst_active WHERE user_fi = %s AND test_fi = %s", array(
                'integer',
                'integer'
            ), array(
                $user_id,
    ...
    public static function _getActiveIdOfUser($user_id = "", $test_id = "")
    {
        ...
        $result = $ilDB->queryF("SELECT tst_active.active_id FROM tst_active WHERE user_fi = %s AND test_fi = %s", array(
            'integer',
            'integer'
        ), array(
            $user_id,
     ...
     *
     * @param array $array
     *            An array which should be shuffled
     * @access public
     */
    ...
    function &getTestResult($active_id, $pass = NULL, $ordered_sequence = FALSE, $considerHiddenQuestions = true, $considerOptionalQuestions = true)
    {
        ...
        $solutionresult = $ilDB->queryF($query, array(
            'integer',
            'integer'
        ), array(
            $active_id,
    ...
    function evalTotalPersons()
    {
        ...
        $result = $ilDB->queryF("SELECT COUNT(active_id) total FROM tst_active WHERE test_fi = %s", array(
            'integer'
        ), array(
            $this->getTestId()
        ));
    ...
    function getCompleteWorkingTime($user_id)
    {
        ...
        $result = $ilDB->queryF("SELECT tst_times.* FROM tst_active, tst_times WHERE tst_active.test_fi = %s AND tst_active.active_id = tst_times.active_fi AND tst_active.user_fi = %s", array(
            'integer',
            'integer'
        ), array(
            $this->getTestId(),
    ...
    function &_getCompleteWorkingTimeOfParticipants($test_id)
    {
        ...
        $result = $ilDB->queryF("SELECT tst_times.* FROM tst_active, tst_times WHERE tst_active.test_fi = %s AND tst_active.active_id = tst_times.active_fi ORDER BY tst_times.active_fi, tst_times.started", array(
            'integer'
        ), array(
            $test_id
        ));
    ...
    function getCompleteWorkingTimeOfParticipant($active_id)
    {
        ...
        $result = $ilDB->queryF("SELECT tst_times.* FROM tst_active, tst_times WHERE tst_active.test_fi = %s AND tst_active.active_id = tst_times.active_fi AND tst_active.active_id = %s ORDER BY tst_times.active_fi, tst_times.started", array(
            'integer',
            'integer'
        ), array(
            $this->getTestId(),
    ...
    public static function _getWorkingTimeOfParticipantForPass($active_id, $pass)
    {
        ...
        $result = $ilDB->queryF("SELECT * FROM tst_times WHERE active_fi = %s AND pass = %s ORDER BY started", array(
            'integer',
            'integer'
        ), array(
            $active_id,
     ...
     *
     * @param integer $active_id
     *            The active ID of the participant
    ...
    function _getVisitTimeOfParticipant($test_id, $active_id)
    {
        ...
        $result = $ilDB->queryF("SELECT tst_times.* FROM tst_active, tst_times WHERE tst_active.test_fi = %s AND tst_active.active_id = tst_times.active_fi AND tst_active.active_id = %s ORDER BY tst_times.started", array(
            'integer',
            'integer'
        ), array(
            $test_id,
    ...
    function &evalStatistical($active_id)
    {
        ...
        $result = $ilDB->queryF("SELECT tst_times.* FROM tst_active, tst_times WHERE tst_active.active_id = %s AND tst_active.active_id = tst_times.active_fi", array(
            'integer'
        ), array(
            $active_id
        ));
    ...
    public function &getParticipants()
    {
        global $DIC;
        $ilDB = $DIC['ilDB'];
        $result = $ilDB->queryF("SELECT tst_active.active_id, usr_data.usr_id, usr_data.firstname, usr_data.lastname, usr_data.title, usr_data.login FROM tst_active LEFT JOIN usr_data ON tst_active.user_fi = usr_data.usr_id WHERE tst_active.test_fi = %s ORDER BY usr_data.lastname ASC", array(
            'integer'
        ), array(
            $this->getTestId()
        ));
    ...
    function &evalTotalPersonsArray($name_sort_order = "asc")
    {
        global $DIC;
        $ilDB = $DIC['ilDB'];
        $result = $ilDB->queryF("SELECT tst_active.active_id, usr_data.firstname, usr_data.lastname, usr_data.title FROM tst_active LEFT JOIN usr_data ON tst_active.user_fi = usr_data.usr_id WHERE tst_active.test_fi = %s ORDER BY usr_data.lastname " . strtoupper($name_sort_order), array(
            'integer'
        ), array(
            $this->getTestId()
        ));
    ...
    function &evalTotalParticipantsArray($name_sort_order = "asc")
    {
        global $DIC;
        $ilDB = $DIC['ilDB'];
        $result = $ilDB->queryF("SELECT tst_active.active_id, usr_data.login, usr_data.firstname, usr_data.lastname, usr_data.title FROM tst_active LEFT JOIN usr_data ON tst_active.user_fi = usr_data.usr_id WHERE tst_active.test_fi = %s ORDER BY usr_data.lastname " . strtoupper($name_sort_order), array(
            'integer'
        ), array(
            $this->getTestId()
        ));
    ...
    function &getQuestionsOfTest($active_id)
    {
        ...
        if ($this->isRandomTest()) {
            ...
            $result = $ilDB->queryF("SELECT tst_test_rnd_qst.sequence, tst_test_rnd_qst.question_fi, " . "tst_test_rnd_qst.pass, qpl_questions.points " . "FROM tst_test_rnd_qst, qpl_questions " . "WHERE tst_test_rnd_qst.question_fi = qpl_questions.question_id " . "AND tst_test_rnd_qst.active_fi = %s ORDER BY tst_test_rnd_qst.sequence", array(
                'integer'
            ), array(
                $active_id
            ));
        } else {
            $result = $ilDB->queryF("SELECT tst_test_question.sequence, tst_test_question.question_fi, " . "qpl_questions.points " . "FROM tst_test_question, tst_active, qpl_questions " . "WHERE tst_test_question.question_fi = qpl_questions.question_id " . "AND tst_active.active_id = %s AND tst_active.test_fi = tst_test_question.test_fi", array(
                'integer'
            ), array(
                $active_id
            ));
    ...
    function &getQuestionsOfPass($active_id, $pass)
    {
        ...
        if ($this->isRandomTest()) {
            $ilDB->setLimit($this->getQuestionCount(), 0);
            $result = $ilDB->queryF("SELECT tst_test_rnd_qst.sequence, tst_test_rnd_qst.question_fi, " . "qpl_questions.points " . "FROM tst_test_rnd_qst, qpl_questions " . "WHERE tst_test_rnd_qst.question_fi = qpl_questions.question_id " . "AND tst_test_rnd_qst.active_fi = %s AND tst_test_rnd_qst.pass = %s " . "ORDER BY tst_test_rnd_qst.sequence", array(
                'integer',
                'integer'
            ), array(
                $active_id,
    ...
    public function buildStatisticsAccessFilteredParticipantList()
    {
        ...
        $list = $list->getAccessFilteredList(ilTestParticipantAccessFilter::getAccessStatisticsUserFilter($this->getRefId()));
    ...
    function getUnfilteredEvaluationData()
    {
        ...
        $result = $ilDB->queryF($query, array(
            'integer'
        ), array(
            $this->getTestId()
        ));
        ...
        foreach (array_keys($data->getParticipants()) as $active_id) {
            if ($this->isRandomTest()) {
                ...
                for ($testpass = 0; $testpass <= $lastPass; $testpass ++) {
                    require_once 'Modules/Test/classes/class.ilObjTestDynamicQuestionSetConfig.php';
                    $dynamicQuestionSetConfig = new ilObjTestDynamicQuestionSetConfig($DIC->repositoryTree(), $DIC->database(), $DIC['ilPluginAdmin'], $this);
                    $dynamicQuestionSetConfig->loadFromDb();
                    ...
                    if (count($questionsIdsToRequest) > 0) {
                        ...
                        $res = $DIC->database()->queryF("
							SELECT * 
							FROM qpl_questions
							WHERE {$questionIdsCondition}", array(
                            'integer'
                        ), array(
                            $active_id
                        ));
                    ...
                    foreach ($sequence as $questionId) {
                        ...
                        $data->getParticipant($active_id)->addQuestion($row['original_id'], $row['question_id'], $row['points'], NULL, $testpass);
                    }
                }
            } else {
                $query = "
                ...
                if ($result->numRows()) {
                    ...
                    $seqresult = $ilDB->queryF("SELECT * FROM tst_sequence WHERE active_fi = %s", array(
                        'integer'
                    ), array(
                        $active_id
                    ));
     ...
     *            Indicates if it is an anonymized test or not
     * @param int $user_id
     *            The database ID of the user
     * @param string $firstname
     *            The first name of the user
    ...
    function evalTotalStartedAverageTime($activeIdsFilter = null)
    {
        ...
        $result = $DIC->database()->queryF($query, array(
            'integer'
        ), array(
            $this->getTestId()
        ));
     ...
     * @param integer $question_id
     *            The question id of the question, if available
     ...
     *
     * @param array $move_questions
     *            An array with the question id's of the questions to move
     * @param integer $target_index
     *            The question id of the target position
     * @param integer $insert_mode
     *            0, if insert before the target position, 1 if insert after the target position
     * @access public
     */
    ...
    public function fromXML(ilQTIAssessment $assessment)
    {
        ...
        if ($assessment->getPresentationMaterial() && $assessment->getPresentationMaterial()->getFlowMat(0) && $assessment->getPresentationMaterial()
            ->getFlowMat(0)
            ->getMaterial(0)) {
            $this->setFinalStatement($this->QTIMaterialToString($assessment->getPresentationMaterial()
                ->getFlowMat(0)
                ->getMaterial(0)));
        }
     ...
     *
     * @param object $a_xml_writer
     *            ilXmlWriter object that receives the
     *            xml data
     */
     ...
     *
     * @param string $author
     *            A string containing the name of the test author
     * @access public
     * @see $author
     */
    ...
    public function cloneObject($a_target_id, $a_copy_id = 0, $a_omit_tree = false)
    {
        ...
        $cloneAction = new ilCertificateCloneAction($ilDB, $pathFactory, $templateRepository, $DIC->filesystem()->web(), $certificateLogger, new ilCertificateObjectHelper());
     ...
     *            The log text
     * @param integer $question_id
     *            If given, saves the question id to the database
     * @access public
     */
    ...
    public static function _getObjectIDFromTestID($test_id)
    {
        ...
        $ilDB = $DIC['ilDB'];
        $object_id = FALSE;
        $result = $ilDB->queryF("SELECT obj_fi FROM tst_tests WHERE test_id = %s", array(
            'integer'
        ), array(
            $test_id
        ));
    ...
    public static function _getObjectIDFromActiveID($active_id)
    {
        ...
        $ilDB = $DIC['ilDB'];
        $object_id = FALSE;
        $result = $ilDB->queryF("SELECT tst_tests.obj_fi FROM tst_tests, tst_active WHERE tst_tests.test_id = tst_active.test_fi AND tst_active.active_id = %s", array(
            'integer'
        ), array(
            $active_id
        ));
    ...
    public static function _getTestIDFromObjectID($object_id)
    {
        ...
        $ilDB = $DIC['ilDB'];
        $test_id = FALSE;
        $result = $ilDB->queryF("SELECT test_id FROM tst_tests WHERE obj_fi = %s", array(
            'integer'
        ), array(
            $object_id
        ));
    ...
    function getTextAnswer($active_id, $question_id, $pass = NULL)
    {
        ...
        if (($active_id) && ($question_id)) {
            ...
            $result = $ilDB->queryF("SELECT value1 FROM tst_solutions WHERE active_fi = %s AND question_fi = %s AND pass = %s", array(
                'integer',
                'integer',
                'integer'
            ), array(
    ...
    function getQuestiontext($question_id)
    {
        ...
        $res = "";
        if ($question_id) {
            $result = $ilDB->queryF("SELECT question_text FROM qpl_questions WHERE question_id = %s", array(
                'integer'
            ), array(
                $question_id
            ));
    ...
    public function getTestParticipantsForManualScoring($filter = NULL)
    {
        ...
        foreach ($participants as $active_id => $participant) {
            ...
            $result = $ilDB->queryF($queryString, array(
                "integer"
            ), array(
                $active_id
            ));
    ...
    function &getUserData($ids)
    {
        ...
        if ($this->getAnonymity()) {
            $result = $ilDB->queryF("SELECT usr_id, %s login, %s lastname, %s firstname, client_ip clientip FROM usr_data WHERE " . $ilDB->in('usr_id', $ids, false, 'integer') . " ORDER BY login", array(
                'text',
                'text',
                'text'
            ), array(
     ...
     *            The database id of the invited group
     * @access public
     */
     ...
     *
     * @param integer $user_id
     *            The database id of the disinvited user
     * @access public
     */
    function disinviteUser($user_id)
    {
        ...
        $affectedRows = $ilDB->manipulateF("DELETE FROM tst_invited_user WHERE test_fi = %s AND user_fi = %s", array(
            'integer',
            'integer'
        ), array(
            $this->getTestId(),
    ...
    function inviteUser($user_id, $client_ip = "")
    {
        ...
        $affectedRows = $ilDB->manipulateF("INSERT INTO tst_invited_user (test_fi, user_fi, clientip, tstamp) VALUES (%s, %s, %s, %s)", array(
            'integer',
            'integer',
            'text',
            'integer'
            ...
            $this->getTestId(),
            $user_id,
            (strlen($client_ip)) ? $client_ip : NULL,
            time()
        ));
    }
    ...
    function setClientIP($user_id, $client_ip)
    {
        ...
        $affectedRows = $ilDB->manipulateF("UPDATE tst_invited_user SET clientip = %s, tstamp = %s WHERE test_fi=%s and user_fi=%s", array(
            'text',
            'integer',
            'integer',
            'integer'
    ...
    public static function _getSolvedQuestions($active_id, $question_fi = null)
    {
        ...
        if (is_numeric($question_fi)) {
            $result = $ilDB->queryF("SELECT question_fi, solved FROM tst_qst_solved WHERE active_fi = %s AND question_fi=%s", array(
                'integer',
                'integer'
            ), array(
                $active_id,
            ...
            $result = $ilDB->queryF("SELECT question_fi, solved FROM tst_qst_solved WHERE active_fi = %s", array(
                'integer'
            ), array(
                $active_id
            ));
    ...
    function setQuestionSetSolved($value, $question_id, $user_id)
    {
        ...
        $affectedRows = $ilDB->manipulateF("DELETE FROM tst_qst_solved WHERE active_fi = %s AND question_fi = %s", array(
            'integer',
            'integer'
        ), array(
            $active_id,
        ...
        $affectedRows = $ilDB->manipulateF("INSERT INTO tst_qst_solved (solved, question_fi, active_fi) VALUES (%s, %s, %s)", array(
            'integer',
            'integer',
            'integer'
        ), array(
    ...
    function isTestFinished($active_id)
    {
        ...
        $result = $ilDB->queryF("SELECT submitted FROM tst_active WHERE active_id=%s AND submitted=%s", array(
            'integer',
            'integer'
        ), array(
            $active_id,
    ...
    function isActiveTestSubmitted($user_id = null)
    {
        ...
        $result = $ilDB->queryF("SELECT submitted FROM tst_active WHERE test_fi=%s AND user_fi=%s AND submitted=%s", array(
            'integer',
            'integer',
            'integer'
        ), array(
     ...
     *
     * @param array $row
     *            The array containing the values for a CSV row
     * @param string $quoteAll
     *            Indicates to quote every value (=TRUE) or only values containing quotes and separators (=FALSE, default)
     * @param string $separator
     *            The value separator in the CSV row (used for quoting) (; = default)
    ...
    public static function _getPass($active_id)
    {
        global $DIC;
        $ilDB = $DIC['ilDB'];
        $result = $ilDB->queryF("SELECT tries FROM tst_active WHERE active_id = %s", array(
            'integer'
        ), array(
            $active_id
        ));
    ...
    public static function _getMaxPass($active_id)
    {
        global $DIC;
        $ilDB = $DIC['ilDB'];
        $result = $ilDB->queryF("SELECT MAX(pass) maxpass FROM tst_pass_result WHERE active_fi = %s", array(
            'integer'
        ), array(
            $active_id
        ));
    ...
    public static function _getBestPass($active_id)
    {
        ...
        $result = $ilDB->queryF("SELECT * FROM tst_pass_result WHERE active_fi = %s", array(
            'integer'
        ), array(
            $active_id
        ));
    ...
    function getStartingTimeOfUser($active_id, $pass = null)
    {
        ...
        $result = $ilDB->queryF("SELECT tst_times.started FROM tst_times WHERE tst_times.active_fi = %s AND tst_times.pass = %s ORDER BY tst_times.started", array(
            'integer',
            'integer'
        ), array(
            $active_id,
     ...
     *
     * @param long $starting_time
     *            The unix timestamp of the starting time of the test
    ...
    function &getTestQuestions()
    {
        ...
        $query_result = $ilDB->queryF($query, array(
            'integer'
        ), array(
            $this->getTestId()
        ));
    ...
    public function checkQuestionParent($questionId)
    {
        ...
        $row = $DIC->database()->fetchAssoc($DIC->database()
            ->queryF("SELECT COUNT(question_id) cnt FROM qpl_questions WHERE question_id = %s AND obj_fi = %s", array(
            'integer',
            'integer'
        ), array(
            $questionId,
    ...
    public function getFixedQuestionSetTotalWorkingTime()
    {
        ...
        foreach ($this->getTestQuestions() as $questionData) {
            $totalWorkingTime = assQuestion::sumTimesInISO8601FormatH_i_s_Extended($totalWorkingTime, $questionData['working_time']);
        }
     ...
     *
     * @param boolean $a_shuffle
     *            0 if the test questions are not shuffled, 1 if the test questions are shuffled
     * @access public
     */
     ...
     *            TRUE if the list of questions should be presented, FALSE otherwise
     * @access public
     */
     ...
     *
     * @param boolean $a_value
     *            TRUE if the list of questions should be the start page, FALSE otherwise
     * @access public
     */
     ...
     *
     * @param boolean $a_value
     *            TRUE if the list of questions should be the end page, FALSE otherwise
     * @access public
     */
     ...
     *
     * @param boolean $a_value
     *            TRUE if the list of questions should be shown with question descriptions, FALSE otherwise
     * @access public
     */
     ...
     *
     * @param integer $a_results_presentation
     *            The combined results presentation value
     * @access public
     */
     ...
     * Sets if the pass details should be shown when a test is not finished
     *
     * @param boolean $a_details
     *            TRUE if the pass details should be shown, FALSE otherwise
     * @access public
     */
     ...
     *
     * @param integer $a_details
     *            1 if the solution details should be presented, 0 otherwise
     * @access public
     */
     ...
     *
     * @param boolean $a_details
     *            TRUE if the solution printview should be presented, FALSE otherwise
     * @access public
     */
     ...
     *
     * @param boolean $a_feedback
     *            TRUE if the feedback should be presented in the solution, FALSE otherwise
     * @access public
     */
     ...
     *
     * @param boolean $a_full
     *            TRUE if the full solution should be shown in the solution output, FALSE otherwise
     * @access public
     */
     ...
     *
     * @param boolean $a_signature
     *            TRUE if the signature field should be shown, FALSE otherwise
     * @access public
     */
     ...
     *
     * @param boolean $a_solution
     *            TRUE if the suggested solution should be shown, FALSE otherwise
     * @access public
     */
     ...
     *
     * @param boolean $a_comparison
     *            TRUE if the list of answers should be shown prior to finish the test, FALSE otherwise
     */
    ...
    public static function _getUserIdFromActiveId($active_id)
    {
        global $DIC;
        $ilDB = $DIC['ilDB'];
        $result = $ilDB->queryF("SELECT user_fi FROM tst_active WHERE active_id = %s", array(
            'integer'
        ), array(
            $active_id
        ));
    ...
    function _getLastAccess($active_id)
    {
        ...
        $result = $ilDB->queryF("SELECT finished FROM tst_times WHERE active_fi = %s ORDER BY finished DESC", array(
            'integer'
        ), array(
            $active_id
        ));
        ...
        for ($i = 0; $i < $a_material->getMaterialCount(); $i ++) {
            ...
            if (strcmp($material["type"], "matimage") == 0) {
                ...
                if (preg_match("/(il_([0-9]+)_mob_([0-9]+))/", $matimage->getLabel(), $matches)) {
                    ...
                    array_push($_SESSION["import_mob_xhtml"], array(
     ...
     *
     * @param object $a_xml_writer
     *            Reference to the ILIAS XML writer
     * @param string $a_material
     *            plain text or html text containing the material
     ...
     *
     * @param string $txt_output
     *            String which should be prepared for output
     * @access public
     */
     ...
     *
     * @param integer $a_value
     *            The value for the visibility settings (0 = always, 1 = only passed, 2 = never)
     * @access private
     */
    function saveCertificateVisibility($a_value)
    {
        ...
        $affectedRows = $ilDB->manipulateF("UPDATE tst_tests SET certificate_visibility = %s, tstamp = %s WHERE test_id = %s", array(
            'text',
            'integer',
            'integer'
        ), array(
     ...
     *
     * @param integer $a_value
     *            The value for the anonymity status (0 = personalized, 1 = anonymized)
     * @access public
     */
     ...
     *
     * @param integer $a_value
     *            The value for the cancel test status (0 = don't show, 1 = show)
     * @access public
     */
     ...
     *
     * @param integer $a_value
     *            The value for the marker status (0 = don't show, 1 = show)
     * @access public
     */
     ...
     *
     * @param integer $a_value
     *            The value for the fixed participants status (0 = don't allow, 1 = allow)
     * @access public
     */
     ...
     *
     * @param int $a_obj_id
     *            The object id of the test object
     * @return integer The value for the anonymity status (0 = personalized, 1 = anonymized)
     * @access public
     */
    public static function _lookupAnonymity($a_obj_id)
    {
        ...
        $result = $ilDB->queryF("SELECT anonymity FROM tst_tests WHERE obj_fi = %s", array(
            'integer'
        ), array(
            $a_obj_id
        ));
    ...
    function _lookupRandomTestFromActiveId($active_id)
    {
        ...
        $result = $ilDB->queryF("SELECT tst_tests.random_test FROM tst_tests, tst_active WHERE tst_active.active_id = %s AND tst_active.test_fi = tst_tests.test_id", array(
            'integer'
        ), array(
            $active_id
        ));
     ...
     * @param int $user_id
     *            The database ID of the user
     * @param boolean $overwrite_anonymity
     *            Indicates if the anonymity status should be ignored
     ...
     *
     * @param int $active_id
     *            The active id of the current user
    ...
    public function getAvailableDefaults()
    {
        ...
        $result = $ilDB->queryF("SELECT * FROM tst_test_defaults WHERE user_fi = %s ORDER BY name ASC", array(
            'integer'
        ), array(
            $ilUser->getId()
        ));
     ...
     *
     * @param integer $test_defaults_id
     *            The database id of a test defaults dataset
    ...
    public static function _getTestDefaults($test_defaults_id)
    {
        ...
        $result = $ilDB->queryF("SELECT * FROM tst_test_defaults WHERE test_defaults_id = %s", array(
            'integer'
        ), array(
            $test_defaults_id
        ));
     ...
     *
     * @param integer $test_default_id
     *            The database ID of the test defaults
     * @access public
     */
    function deleteDefaults($test_default_id)
    {
        global $DIC;
        $ilDB = $DIC['ilDB'];
        $affectedRows = $ilDB->manipulateF("DELETE FROM tst_test_defaults WHERE test_defaults_id = %s", array(
            'integer'
        ), array(
            $test_default_id
        ));
    ...
    function addDefaults($a_name)
    {
        ...
        $ilDB->insert('tst_test_defaults', array(
            ...
            'defaults' => array(
                'clob',
                serialize($testsettings)
            ),
            'marks' => array(
                'clob',
                serialize($this->mark_schema)
            ),
            'tstamp' => array(
                'integer',
                time()
     ...
     *
     * @param array $test_default
     *            The test defaults database id.
     *            
    ...
    function processPrintoutput2FO($print_output)
    {
        ...
        global $DIC;
        $xsl = str_replace('font-family="Helvetica, unifont"', 'font-family="' . $DIC['ilSetting']->get('rpc_pdf_font', 'Helvetica, unifont') . '"', $xsl);
    ...
    public static function getSingleManualFeedback($active_id, $question_id, $pass)
    {
        ...
        $ilDB = $DIC->database();
        $row = array();
        $result = $ilDB->queryF("SELECT * FROM tst_manual_fb WHERE active_fi = %s AND question_fi = %s AND pass = %s", array(
            'integer',
            'integer',
            'integer'
        ), array(
        ...
        if ($result->numRows() === 1) {
            ...
            $DIC->logger()
                ->root()
                ->warning("WARNING: Multiple feedback entries on tst_manual_fb for " . "active_fi = $active_id , question_fi = $question_id and pass = $pass");
        }
    ...
    public static function getCompleteManualFeedback(int $question_id)
    {
        ...
        $ilDB = $DIC->database();
        $feedback = array();
        $result = $ilDB->queryF("SELECT * FROM tst_manual_fb WHERE question_fi = %s", array(
            'integer'
        ), array(
            $question_id
        ));
    ...
    function saveManualFeedback($active_id, $question_id, $pass, $feedback, $finalized = false, $is_single_feedback = false)
    {
        ...
        if ($finalized_record === 0 || ($is_single_feedback && $finalized_record === 1)) {
            $DIC->database()->manipulateF("DELETE FROM tst_manual_fb WHERE active_fi = %s AND question_fi = %s AND pass = %s", array(
                'integer',
                'integer',
                'integer'
            ), array(
     ...
     * @param string $feedback
     *            The feedback text
     * @param array $feedback_old
     *            The feedback before update
     * @param boolean $finalized
     *            In Feedback is final
     */
    private function insertManualFeedback($active_id, $question_id, $pass, $feedback, $finalized, $feedback_old)
    {
        ...
        if ($finalized === true || $feedback_old['finalized_evaluation'] == 1) {
            if (! array_key_exists('evaluated', $_POST)) {
                $update_default['finalized_evaluation'] = [
                    'integer',
                    0
                ];
                $update_default['finalized_by_usr_id'] = [
                    'integer',
                    0
                ];
                $update_default['finalized_tstamp'] = [
                    'integer',
                    0
                ];
            } else {
    ...
    public static function _lookupTestObjIdForQuestionId($a_q_id)
    {
        ...
        $result = $ilDB->queryF("SELECT t.obj_fi obj_id FROM tst_test_question q, tst_tests t WHERE q.test_fi = t.test_id AND q.question_fi = %s", array(
            'integer'
        ), array(
            $a_q_id
        ));
    ...
    public function getPassed($active_id)
    {
        ...
        $result = $ilDB->queryF("SELECT passed FROM tst_result_cache WHERE active_fi = %s", array(
            'integer'
        ), array(
            $active_id
        ));
    ...
    public function getParticipantsForTestAndQuestion($test_id, $question_id)
    {
        ...
        while ($row = $ilDB->fetchAssoc($result)) {
            ...
            array_push($foundusers[$row["active_fi"]], array(
                "pass" => $row["pass"],
                "qid" => $row["question_fi"]
            ));
        }
    ...
    public function moveQuestionAfterOLD($previous_question_id, $new_question_id)
    {
        ...
        foreach ($new_array as $position => $qid) {
            $ilDB->manipulateF($update_query, $update_types, $vals = array(
                $position,
                $this->getTestId(),
                $qid
            ));
    ...
    {
        return ($this->getSpecificAnswerFeedback() || $this->getGenericAnswerFeedback() || $this->getAnswerFeedbackPoints() || $this->getInstantFeedbackSolution());
    }
    ...
    public function setQuestionOrderAndObligations($orders, $obligations)
    {
        ...
        foreach ($orders as $id => $position) {
            ...
            $obligatory = (isset($obligations[$id]) && $obligations[$id] ? 1 : 0);
    ...
    public static function _lookupFinishedUserTests($a_user_id)
    {
        ...
        $result = $ilDB->queryF("SELECT test_fi,MAX(pass) AS pass FROM tst_active" . " JOIN tst_pass_result ON (tst_pass_result.active_fi = tst_active.active_id)" . " WHERE user_fi=%s" . " GROUP BY test_fi", array(
            'integer',
            'integer'
        ), array(
            $a_user_id,
     ...
     *
     * @param bool $a_own_table
     *            True, if table with own ranking should be shown.
     */
     ...
     * table.
     *
     * @param integer $a_top_num
     *            Number of entries in the top-rankings table.
     */
     ...
     * Default: 10 entries
     *
     * @param integer $a_retval
     *            Optional return value if nothing is set, defaults to 10.
     *            
    ...
    public static function isQuestionObligationPossible($questionId)
    {
        ...
        $obligationPossible = call_user_func(array(
            $classConcreteQuestion,
    ...
    public static function isQuestionObligatory($question_id)
    {
        ...
        $rset = $ilDB->queryF('SELECT obligatory FROM tst_test_question WHERE question_fi = %s', array(
            'integer'
        ), array(
            $question_id
        ));
    ...
    public static function allObligationsAnswered($test_id, $active_id, $pass)
    {
        ...
        $rset = $ilDB->queryF('SELECT obligations_answered FROM tst_pass_result WHERE active_fi = %s AND pass = %s', array(
            'integer',
            'integer'
        ), array(
            $active_id,
    ...
    public static function hasObligations($test_id)
    {
        ...
        $rset = $ilDB->queryF('SELECT count(*) cnt FROM tst_test_question WHERE test_fi = %s AND obligatory = 1', array(
            'integer'
        ), array(
            $test_id
        ));
    ...
    function getTimeExtensionsOfParticipants()
    {
        ...
        $times = array();
        $result = $ilDB->queryF("SELECT tst_addtime.active_fi, tst_addtime.additionaltime FROM tst_addtime, tst_active WHERE tst_addtime.active_fi = tst_active.active_id AND tst_active.test_fi = %s", array(
            'integer'
        ), array(
            $this->getTestId()
        ));
    ...
    public function getExtraTime($active_id)
    {
        ...
        $result = $ilDB->queryF("SELECT additionaltime FROM tst_addtime WHERE active_fi = %s", array(
            'integer'
        ), array(
            $active_id
        ));
    ...
    public function addExtraTime($active_id, $minutes)
    {
        ...
        $participantData->setParticipantAccessFilter(ilTestParticipantAccessFilter::getManageParticipantsUserFilter($this->getRefId()));

        if ($active_id) {
            $participantData->setActiveIdsFilter(array(
                $active_id
            ));
        }
        ...
        foreach ($participantData->getActiveIds() as $active_id) {
            $result = $DIC->database()->queryF("SELECT active_fi FROM tst_addtime WHERE active_fi = %s", array(
                'integer'
            ), array(
                $active_id
            ));
            ...
            if ($result->numRows() > 0) {
                $DIC->database()->manipulateF("DELETE FROM tst_addtime WHERE active_fi = %s", array(
                    'integer'
                ), array(
                    $active_id
                ));
            ...
            $DIC->database()->manipulateF("UPDATE tst_active SET tries = %s, submitted = %s, submittimestamp = %s WHERE active_id = %s", array(
                'integer',
                'integer',
                'timestamp',
                'integer'
            ...
            $DIC->database()->manipulateF("INSERT INTO tst_addtime (active_fi, additionaltime, tstamp) VALUES (%s, %s, %s)", array(
                'integer',
                'integer',
                'integer'
            ), array(
    ...
    public static function lookupExamId($active_id, $pass)
    {
        ...
        $exam_id_result = $ilDB->queryF($exam_id_query, array(
            'integer',
            'integer'
        ), array(
            $active_id,
    ...
    public function adjustTestSequence()
    {
        ...
        $questRes = $ilDB->queryF($query, array(
            'integer'
        ), array(
            $this->getTestId()
        ));
        ...
        if ($this->getShuffleQuestions()) {
            ...
            $partRes = $ilDB->queryF($query, array(
                'integer'
            ), array(
                $this->getTestId()
            ));
            ...
            $part_rest = $ilDB->queryF($query, array(
                'integer'
            ), array(
                $this->getTestId()
            ));
