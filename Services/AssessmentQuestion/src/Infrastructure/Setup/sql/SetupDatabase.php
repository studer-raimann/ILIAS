...
class SetupDatabase {
	...
	public function run():void {
        ...
        $DIC->database()->query("UPDATE copg_pobj_def SET component = 'Services/AssessmentQuestion',  class_name = 'AsqPageObject', directory = 'src/UserInterface/Web/Page' where parent_type = 'asqg'");
        ...
        $DIC->database()->query("UPDATE copg_pobj_def SET component = 'Services/AssessmentQuestion',  class_name = 'AsqPageObject', directory = 'src/UserInterface/Web/Page' where parent_type = 'asqa'");
